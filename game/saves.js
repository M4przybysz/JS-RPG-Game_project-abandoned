...
const Start_save = {
    ...
    Item_list : {  
        // Armor
        test_iron_head_armor : new Armor('test_iron_head_armor', 'test_iron_head_armor', 31, 20, 'iron_head_armor', 'head', 20),
        test_iron_torso_armor : new Armor('test_iron_torso_armor', 'test_iron_torso_armor', 31, 21, 'iron_torso_armor', 'torso', 20),
        test_iron_legs_armor : new Armor('test_iron_legs_armor', 'test_iron_legs_armor', 31, 22, 'iron_legs_armor', 'legs', 20),

        // Food 
        test_bread : new Food('test_bread', 'test_bread', 31, 19, 'bread', 20),

        // Healing  
        test_healing_potion : new Healing('test_healing_potion', 'test_healing_potion', 31, 18, 'healing_potion', 20),
        test_mana_potion : new Healing('test_mana_potion', 'test_mana_potion', 31, 17, 'mana_potion', 20),
        
        //  Weapons
        test_rich_longsword : new Weapon('test_rich_longsword','test_rich_longsword', 31, 16, 'rich_longsword', 20),
        test_magic_short_sword : new Weapon('test_magic_short_sword', 'test_magic_short_sword', 31, 15, 'magic_short_sword', 20),
        test_stick : new Weapon('test_stick', 'test_stick', 31, 14, 'stick', 10),
    },  
    MapObj_list : {
        test_map_object : new MapObj('test_map_object', 2, 2, 'fire'),

        fire1 : new MapObj('test_map_object', 32, 25, 'fire'),
        fire2 : new MapObj('test_map_object', 33, 25, 'fire'),
        fire3 : new MapObj('test_map_object', 29, 25, 'fire'),
        fire4 : new MapObj('test_map_object', 28, 25, 'fire'),
